...
### 5-3. LPF/LPF2
　カットオフ周波数FREQというものを指定して、その周波数より高い音を少なくします。一般的に音色がマイルドになります。LPFではカットオフ周波数そのものを指定し、LPF2ではノートオンした音程からのオフセット周波数（マイナス値可）を指定します。  
　レゾナンスまたはQファクターという値RESOは、指定した周波数部分を際立たせる働きを持ちます。値を大きくすると、一般的にはギュイーンというようなギラギラした音色が出ます。  

### 5-4. HPF/HPF2
　カットオフ周波数FREQというものを指定して、その周波数より低い音を少なくします。一般的に音色がシャリシャリになります。HPFではカットオフ周波数そのものを指定し、HPF2ではノートオンした音程からのオフセット周波数（マイナス値可）を指定します。  
　レゾナンスまたはQファクターという値RESOは、指定した周波数部分を際立たせる働きを持ちます。値を大きくすると、一般的にはギュイーンというようなギラギラした音色が出ます。  

### 5-5. BPF/BPF2
　カットオフ周波数FREQというものを指定して、その周波数から離れた音を少なくします。BPFではカットオフ周波数そのものを指定し、BPF2ではノートオンした音程からのオフセット周波数（マイナス値可）を指定します。  
　レゾナンスまたはQファクターという値RESOは、指定した周波数部分を際立たせる働きを持ちます。値を大きくすると、一般的にはギュイーンというようなギラギラした音色が出ます。  

### 5-6. NOTCH/NOTCH2
　カットオフ周波数FREQというものを指定して、その周波数の周辺の音を少なくします。NOTCHではカットオフ周波数そのものを指定し、NOTCH2ではノートオンした音程からのオフセット周波数（マイナス値可）を指定します。  
　レゾナンスまたはQファクターという値RESOは、指定した周波数部分を際立たせる働きを持ちます。値を大きくすると、一般的にはギュイーンというようなギラギラした音色が出ます。  
